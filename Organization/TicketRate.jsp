...
<html>
    ...
    <body>
        ...
        if(request.getParameter("btnsave")!=null){
            String ins="insert into tbl_ticketrates(tickettype_id,trate_value,orgevent_id)values('"+request.getParameter("type")+"','"+request.getParameter("txtrate")+"','"+request.getParameter("aid")+"')";
        ...
        <form method="post">
            <table border="1" cellpadding="10" style="border-collapse: collapse">
               ...
               <%
                String s="select * from tbl_ticketrates v inner join tbl_tickettype tt on tt.tickettype_id=v.tickettype_id inner join tbl_orgevent ae on ae.orgevent_id=v.orgevent_id where ae.orgevent_id='"+request.getParameter("aid")+"'";
            ...
            <tr>
                ...
                <td><%=r.getString("orgevent_name")%></td>
