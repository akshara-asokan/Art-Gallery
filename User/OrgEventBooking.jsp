        ...
        function getPrice(did)
{
	//alert(did);
	$.ajax({
	url: "../Assets/Ajaxpages/Ajaxamounts.jsp?did="+did,
          ...
          if(request.getParameter("btn")!=null){
             ...
             int r_num=r.nextInt(1111)+999;
              if(request.getParameter("selt").equals("2")){
                  ...
                  String ins="insert into tbl_ticketbooking(customer_id,tickettype_id,ticket_count,booking_date,booked_date,ticket_number,ticket_total,orgevent_id)values('"+session.getAttribute("userid")+"','2','"+request.getParameter("txtnum")+"','"+request.getParameter("txt")+"',curdate(),'"+r_num+"','"+request.getParameter("totalamount")+"','"+session.getAttribute("eid")+"')";
                  con.executeCommand(ins);
                  
                  response.sendRedirect("TicketPay.jsp");
              }
              else{
                   String ins="insert into tbl_ticketbooking(customer_id,tickettype_id,ticket_count,booked_date,ticket_number,ticket_total,orgevent_id)values('"+session.getAttribute("userid")+"','1','"+request.getParameter("txtnum")+"',curdate(),'"+r_num+"','"+request.getParameter("totalamount")+"','"+session.getAttribute("eid")+"')";
                  con.executeCommand(ins);
