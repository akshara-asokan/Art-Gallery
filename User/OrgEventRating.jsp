<%-- 
    Document   : ArtworkRating
    Created on : Apr 8, 2022, 10:37:04 PM
    Author     : SONY VAIO
--%>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="txt_lid" id="txt_lid" value="<%=request.getParameter("aid")%>" />
                </div>
                <div class="form-group">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#save_review').click(function() {
            ...
            {
                $.ajax({
                    url: "../Assets/Ajaxpages/AjaxOrgEventRating.jsp",
                    method: "POST",
