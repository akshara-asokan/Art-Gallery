...
<%
    ...
    {    
        String sel="select max(booking_id)  as id from tbl_ticketbooking where customer_id='"+session.getAttribute("userid")+"'";
        ResultSet rs=con.selectCommand(sel);
        rs.next();
        session.setAttribute("tic", rs.getString("id"));
        String up="update tbl_ticketbooking set payment_status=1 where booking_id='"+rs.getString("id")+"'";
        con.executeCommand(up);
        response.sendRedirect("ArtistTicket.jsp");
        
//    session.setAttribute("id", request.getParameter("bid"));
//        String str1 = "insert into tbl_artworkbooking(bid_id,artworkbooking_date,payment_status)values('" + session.getAttribute("id") + "',curdate(),'1')";
//        boolean status=con.executeCommand(str1); 
//        session.setAttribute("aname", request.getParameter("aname"));
//        session.setAttribute("amail", request.getParameter("amail"));
//        session.setAttribute("uname", request.getParameter("uname"));
//        session.setAttribute("umail", request.getParameter("umail"));
//       
//        if (status == true) {
//                    DB.mailconnection m = new DB.mailconnection();
//                    String mailid[] = { request.getParameter("amail") };
...
//                                + " Your payment for the service is completed. \r\n Check it out... \r\n\r\n"
//                                + " We established Trinity Art in order to sell your artwork. \r\n"
...
//                                + " This is from Trinity Art. \r\n\r\n"
//                                + " Your Completed the payment for the booked service. \r\n Check it out... \r\n\r\n"
//                                + " We established Dream Build in order to buy artworks. \r\n"
//                                + " If you have any questions,and if there is anything we can improve please reply to this email. \r\n"
//                                + " we were always happy to help!. \r\n \r\n"
//                                + " Trinity Art.";
