<%-- 
    Document   : Complaint
    Created on : Mar 18, 2022, 3:27:39 PM
    Author     : SONY VAIO
--%>
      ...
      <%
          ...
          session.setAttribute("arid",request.getParameter("arid"));
             if(request.getParameter("btnsave")!=null)
            {
             ...
             String s="insert into tbl_complaint(customer_id,artist_id,artistevent_id,complaint_description,complaint_date) values('"+session.getAttribute("userid")+"','"+session.getAttribute("arid")+"','"+session.getAttribute("aid")+"','"+request.getParameter("txtcomplaint")+"',curdate())"; 
            //out.println(s);
    ...
    <form name="frmComplaint" method="post">
        <table align="center">
          ...
          <tr>
            ...
            <table><tr>
           <%
            String s="select * from tbl_complaint where customer_id='"+session.getAttribute("userid")+"' and organization_id='0'";
