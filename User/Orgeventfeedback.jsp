      ...
      <%
          ...
          session.setAttribute("arid",request.getParameter("arid"));
             if(request.getParameter("btnsave")!=null)
            {
             ...
             String s="insert into tbl_feedback(customer_id,organization_id,orgevent_id,feedback_description,feedback_date) values('"+session.getAttribute("userid")+"','"+session.getAttribute("arid")+"','"+session.getAttribute("aid")+"','"+request.getParameter("txtfeedback")+"',curdate())"; 
            //out.println(s);
