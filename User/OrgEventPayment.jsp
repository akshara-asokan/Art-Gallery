...
<%
    ...
    {    
       ...
       String sel="select * from tbl_orgeventticket otb inner join tbl_orgevent oe on otb.orgevent_id=oe.orgevent_id  inner join tbl_customer c on c.customer_id=otb.customer_id where otb.customer_id='"+session.getAttribute("userid")+"'";
       ResultSet rs=con.selectCommand(sel);
       while(rs.next())
       {
       String event=rs.getString("orgevent_name");
       ...
       // response.sendRedirect("Loader.jsp");
        response.sendRedirect("ViewOrgEvent.jsp");
    }
%>
