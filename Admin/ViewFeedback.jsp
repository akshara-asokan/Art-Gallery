...
<html>
 ...
 <%
            String se1="select * from tbl_feedback f inner join tbl_customer c on f.customer_id=c.customer_id inner join tbl_artist ar on f.artist_id=ar.artist_id inner join tbl_artistevent ae on ae.artistevent_id=f.artistevent_id";
