<%-- 
    Document   : EventPayment
    Created on : Mar 18, 2022, 12:58:23 PM
    Author     : SONY VAIO
--%>
...
<%
    ...
    session.setAttribute("rid", request.getParameter("rid"));
        String up="update tbl_orgeventreq set payment_status='1' where orgeventreq_id='"+session.getAttribute("rid")+"'";
        ...
        if (status == true) {
                    ...
                    String subject = "Event Payment";
                   

                        String text = "Respected " + name + "  \r\n \r\n"
                                + " This is from Trinity Art. \r\n\r\n"
                                + " Your payment for the participation of event is completed. \r\n Check it out... \r\n\r\n"
