...
<html>
    <head>
        ...
        <title>Artist change password</title>
    </head>
    <body>
        <%
            if(request.getParameter("btnsave")!=null)
            {
                ...
                confirm=request.getParameter("txtpwd3");
                 String sel="select * from tbl_artist where artist_id='"+session.getAttribute("artistid")+"' and artist_password='"+current+"' ";
            ...
            if(rs.next())
            {
                 ...
                 {
                     String up="update tbl_artist set artist_password='"+ne+"' where artist_id='"+session.getAttribute("artistid")+"'";
