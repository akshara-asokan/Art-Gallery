...
String fn="";
String photo="";
String up="update tbl_customer set ";
    ...
    while(itr.hasNext())
    {
       ...
       else
       {
         ...
         String ext=file_name.substring(file_name.lastIndexOf("."));
           ...
           up+="customer_photo='"+fn+"',";
       }
    }
           }
    
    //Strinh str1="insert into tbl_wantedlist ()";
        up+=" customer_name='"+value[0]+"',customer_contact='"+value[1]+"',customer_email='"+value[2]+"',customer_address='"+value[3]+"',customer_dob='"+value[4]+"' where customer_id='"+session.getAttribute("userid")+"'";
   ...
   //out.println(up);
    ...
    if(status==true)
    {
      ...
      <script type="text/javascript">
            ...
            setTimeout(function(){window.location.href='../../User/UserEditProfile.jsp'},100);
        </script>
     <%
    }
     }   
