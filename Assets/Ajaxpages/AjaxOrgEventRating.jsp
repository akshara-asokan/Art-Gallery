<%-- 
    Document   : AjaxOrgEventRating
    Created on : Apr 9, 2022, 12:11:28 PM
    Author     : SONY VAIO
--%>
...
<%
    ...
    if (request.getParameter("rating_data") != null) {
        ...
        String ins = "INSERT INTO tbl_eventrating(user_name,customer_id,organization_id,orgevent_id,rating_value,rating_feedback,rating_date)"
                + "VALUES('" + request.getParameter("user_name") + "','"+session.getAttribute("userid")+"','"+session.getAttribute("arid")+"','"+request.getParameter("labour_id")+"','" + request.getParameter("rating_data") + "','" + request.getParameter("user_review") + "',SYSDATE())";
out.println(ins);
    ...
    if (request.getParameter("action") != null) {
        ...
        String query = "SELECT * FROM tbl_eventrating where orgevent_id = '"+request.getParameter("lid")+"' ORDER BY rating_date DESC";
